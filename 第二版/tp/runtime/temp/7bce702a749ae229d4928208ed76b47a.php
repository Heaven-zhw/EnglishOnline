<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"F:\php\WWW\tp5\tp\public/../application/index/view/exam/wx.html";i:1558250570;}*/ ?>
...
<head>
    ...
    <script>
        ...
        var wxnuma=<?php echo $wxnuma; ?>;
        var wxnumb=<?php echo $wxnumb; ?>;
        var rightnum;
        var errornum=sumnum;
        ...
        function sendcollocation(bids){
            ...
            $.ajax({
                type: 'post', // 提交方式 get/post
                url: 'http://127.0.0.1:8090/public/index.php/index/index/collocationwx', // 需要提交的 url
                data:{
                    'pid1':tid1
                }
            });
    ...
    <div class="chapContent">
        <div class="contentright" id="contentright"style="position: static; top: 91.2px; right: 0px;">
            ...
            <div class="doproblemsnumber" id="answer_card">
                <div class="dopronumbertype" showtypeid="1">完型填空1</div>
                <ul titletpye="1" showtypeid="172" class="dopronumbercont" id="pannelShowType172">
                    <?php if(is_array($wx1) || $wx1 instanceof \think\Collection || $wx1 instanceof \think\Paginator): $i = 0; $__LIST__ = $wx1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wx): $mod = ($i % 2 );++$i;?>
                    <li titlenumber="<?php echo $i; ?>" titletpye="<?php echo $i; ?>" showtypeid="172" id="<?php echo $i; ?>k" class="">
                        <?php echo $wx['id']; ?>
                    </li>
                  <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
                <div class="dopronumbertype" showtypeid="1">完型填空2</div>
                <ul titletpye="1" showtypeid="172" class="dopronumbercont" id="pannelShowType173">
                    <?php if(is_array($wx2) || $wx2 instanceof \think\Collection || $wx2 instanceof \think\Paginator): $i = 0; $__LIST__ = $wx2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wx): $mod = ($i % 2 );++$i;?>
                    <li titlenumber="<?php echo $i; ?>" titletpye="<?php echo $i; ?>" showtypeid="172" id="<?php echo $i; ?>kk" class="">
                        <?php echo $wx['id']; ?>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
            ...
            <div class="contentleftcont" id="exam">
                ...
                <div class="DetailTitlecontent">
                    <div class="DetailTitletitle">
                        ...
                        <?php if(is_array($wxa) || $wxa instanceof \think\Collection || $wxa instanceof \think\Paginator): $i = 0; $__LIST__ = $wxa;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ts): $mod = ($i % 2 );++$i;?>
                        ...
                        <?php endforeach; endif; else: echo "" ;endif; if(($wxenable==1)): ?>
                        <div class="DetailTitletitle">
                            <div class="DetailTitletitlecont">
                                <h4><i>2[完型填空]</i>
                                    <?php echo $text2; ?>
                            ...
                            <?php if(is_array($wxb) || $wxb instanceof \think\Collection || $wxb instanceof \think\Paginator): $i = 0; $__LIST__ = $wxb;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ts): $mod = ($i % 2 );++$i;?>
                            <div  class="DetailTitletitlecontmoreselect" data-type="2" >
                                <div class="DetailTitletitlecont">
                                    <h4><i><?php echo $i; ?></i>
                                        _____________________
